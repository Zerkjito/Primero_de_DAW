...
public class PracticaRomaV1 {
    ...
    public static void main(String[] args) {
        ...
        double diferencia, diferencia2, importeInicial, importeFinal;
        boolean cupon = false;
        ...
        if (tamaño != 'G' && tamaño != 'M' && tamaño != 'P') {
            ...
            if (ingrExtra > 3) {
                ...
                if (numeroPizzas > 20) {
                    ...
                    sc.nextLine();
                    System.out.println("¿Posee un cupón de descuento? (SI / NO)");
                    ...
                    if (cuponDisponible.equals("SI") || cuponDisponible.equals("NO")) {
                        System.out.println("¿Es su primer pedido con nosotros? (Por favor, recuerde que podemos verificar dicha información)");
                    ...
                    if (cuponDisponible.equals("SI") || cuponDisponible.equals("NO")) {
                        ...
                        if (cupon == true && primeraCompraDescuento == true && importeInicial > 20) {
                            ...
                            System.out.printf("Descuento por pizza grande: %.1f%% -> %.2f€ \n", porcentajeDescuento * 100, diferencia);
