...
public class TiendaMascotas {
    ...
    public static void leerDatos() {
        ...
        int gatosQueLeer = UtilidadesInput.leerEnteroEnRango("Cantidad de gatos a registrar: ", "Error: Cantidad de gatos debe ser entre 0 y " + tiendaMascotas.length, 0, tiendaMascotas.length);
        ...
        int perrosQueLeer = UtilidadesInput.leerEnteroEnRango("Cantidad de gatos a registrar: ", "Error: Cantidad de gatos debe ser entre 0 y " + tiendaMascotas.length, 0, tiendaMascotas.length);
